...
# Plot 3
png(filename = "plot3.png", width = 480, height = 480, units = "px", pointsize = 12, bg = "white",  res = NA, type = c("cairo", "cairo-png", "Xlib", "quartz"))
...
legend("topright", lty=c(1,1,1), lwd=c(2.5,2.5,2.5),c('Sub_metering1', 'Sub_metering_2', 'Sub_metering_3'), col=c('black','red','blue'))
dev.off()
